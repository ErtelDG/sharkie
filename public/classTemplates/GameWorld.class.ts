   ...
   async draw() {
      if (this.ctx != null) {
         ...
         this.drawRectangle(
            ...
            this.sharkie[0].collisionPointY_RIGHT,
         ...
         for (let pufferFish = 0; pufferFish < 10; pufferFish++) {
            ...
            this.drawRectangle(
               ctx,
               pufferFi.collisionPointX_LEFT,
               pufferFi.collisionPointY_TOP,
               pufferFi.collisionPointY_RIGHT,
               pufferFi.collisionPointY_BOTTOM
            );
         }
